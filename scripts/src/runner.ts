...
import studentsRouter from "../../artifacts/api-server/src/routes/students";
import internshipsRouter from "../../artifacts/api-server/src/routes/internships";
import recommendationsRouter from "../../artifacts/api-server/src/routes/recommendations";
import interactionsRouter from "../../artifacts/api-server/src/routes/interactions";
import { db, studentsTable, internshipsTable, recommendationsTable, interactionsTable } from "@workspace/db";
